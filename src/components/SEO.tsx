...
function getMetadata(pathname: string): SeoMetadata {
  if (pathname === "/") {
    return {
...
function setMeta(
  ...
  const selector = `meta[data-seo="${key}"]`;
...
export default function SEO(): null {
  ...
  useEffect(() => {
    ...
    setMeta("description", "name", "description", metadata.description);
    setMeta("robots", "name", "robots", metadata.robots);
    setMeta("og-title", "property", "og:title", metadata.title);
    setMeta("og-description", "property", "og:description", metadata.description);
    setMeta("og-url", "property", "og:url", canonicalUrl);
    setMeta("og-type", "property", "og:type", "website");
    setMeta("og-locale", "property", "og:locale", "en_GB");
    setMeta("og-site-name", "property", "og:site_name", siteName);
    setMeta("twitter-card", "name", "twitter:card", "summary_large_image");
    setMeta("twitter-title", "name", "twitter:title", metadata.title);
    setMeta(
      "twitter-description",
      "name",
      "twitter:description",
